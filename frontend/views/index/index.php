            ...
            <ul>
                <li>您好，欢迎来到京西！
                    <?php if(Yii::$app->user->isGuest):?>
                        [<?=\yii\bootstrap\Html::a('登录',['login/index'])?>] [<?=\yii\bootstrap\Html::a('免费注册',['regist/index'])?>]
                    <?php else:?>
                        <?=Yii::$app->user->identity->username?>
                        [<?=\yii\bootstrap\Html::a('注销',['login/logout'])?>]
                    <?php endif;?>
...
<div class="header w1210 bc mt15">
        ...
        <div class="user fl">
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        <?php if(Yii::$app->user->isGuest):?>
                            您好，请<?=\yii\bootstrap\Html::a('登录',['login/index'])?>
                        <?php else:?>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                    <?php foreach($categorys as $k=>$category1): ?>
                <div class="cat <?=$k?'':'item1'?>">
                    <h3><a href="<?=\yii\helpers\Url::to(['index/list','category_id'=>$category1->id])?>"><?=$category1->name?></a> <b></b></h3>
                    <div class="cat_detail">
                    <?php foreach($category1->children(1)->all() as $i=>$category2):?>
                        <dl <?= $i?'':'class="d1_1st"'?>>
                            <dt><a href="<?=\yii\helpers\Url::to(['index/list','category_id'=>$category2->id])?>"><?= $category2->name?></a></dt>
                            <dd>
                                <?php foreach($category2->children()->all() as $category3):?>
                                <a href="<?=\yii\helpers\Url::to(['index/list','category_id'=>$category3->id])?>"><?= $category3->name?></a>
                                <?php endforeach;?>
                            </dd>
                        </dl>
                        <?php endforeach;?>
