       ...
       <?php  foreach ($models as  $model):
           ?>
            <tr data-id="<?=$model->id?>">
                ...
                <td class="col3">￥<span class="acol3"><?=$model->shop_price?></span></td>
                <td class="col4">
                    <a href="javascript:;" class="reduce_num"></a>

                    <input type="text" name="amount" id="<?=$model->id?>" value="<?=$carts[$model->id]?>" class="amount"/>

                    <a href="javascript:;" class="add_num"></a>
                </td>
                <td class="col5">￥<span><?=$model->shop_price*$carts[$model->id]?></span></td>
                <td class="col6"><a href="javascript:;" id="" class="delete">删除</a></td>
            </tr>
           <?php $total+=intval($model->shop_price*$carts[$model->id]); ?>
         <?php endforeach;?>
